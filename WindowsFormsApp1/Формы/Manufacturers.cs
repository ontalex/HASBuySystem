...
namespace WindowsFormsApp1.Формы
{
    public partial class Manufacturers : Form
    {
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            ...
            // Запрос к БД
            con.Open();
            string str = $"DELETE FROM Производитель  WHERE id_производитель = {id}";
        ...
        private void add_Click(object sender, EventArgs e)
        {
            ...
            // Запрос к БД
            con.Open();
            string str = $"INSERT INTO Производитель VALUES ({id}, '{name}', {inn})";
            OleDbCommand cmd = new OleDbCommand(str, con);
        ...
        private void button_reload_Click(object sender, EventArgs e)
        {
            ...
            // Запрос к БД
            con.Open();
            string str = $"UPDATE Производитель SET наименование='{name}', ИНН={inn} WHERE id_поизводитель={id}";
            OleDbCommand cmd = new OleDbCommand(str, con);
        ...
        private void button_download_Click(object sender, EventArgs e)
        {
            ...
            dataAdapter.Fill(ds, "производитель");
